// Theme toggle — include after <body> opens
// Requires: <button id="themeToggle" class="theme-toggle"> in HTML
// Early theme detection IIFE must be inlined in <head> separately.
...
function _syncThemeIcon() {
  _themeToggle.innerHTML = document.documentElement.getAttribute('data-theme') === 'dark' ? SUN : MOON;
}
_syncThemeIcon();
_themeToggle.addEventListener('click', () => {
  const next = document.documentElement.getAttribute('data-theme') === 'dark' ? 'light' : 'dark';
  document.documentElement.setAttribute('data-theme', next);
  localStorage.setItem('parselab-theme', next);
  _syncThemeIcon();
});
